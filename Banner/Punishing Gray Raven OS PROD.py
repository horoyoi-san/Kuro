...
def check_for_updates():
    urls = [
        ("https://prod-alicdn-gamestarter.kurogame.com/pcstarter/prod/starter/4/G143/index.json", "Punishing Gray Raven OS (Launcher)"),
        ("https://prod-alicdn-gamestarter.kurogame.com/pcstarter/prod/game/G143/4/index.json", "Punishing Gray Raven OS (Game)")
    ]
