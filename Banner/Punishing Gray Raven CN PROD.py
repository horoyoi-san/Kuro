...
def send_webhook(data, url, title, webhook_url):
    ...
    extra_url = "https://static.wikia.nocookie.net/punishing-gray-raven/images/3/3c/V2-c836b61861815c5f798429ba1f021b87_1200x500.jpg"
...
def check_for_updates():
    urls = [
        ("https://prod-cn-alicdn-gamestarter.kurogame.com/pcstarter/prod/starter/10001/G148/index.json", "Punishing Gray Raven CN (Launcher)"),
        ("https://prod-cn-alicdn-gamestarter.kurogame.com/pcstarter/prod/game/G148/10001/index.json", "Punishing Gray Raven CN (Game)")
    ]
