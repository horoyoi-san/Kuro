...
def send_webhook(data, title, webhook_url, batch_size=1):
    ...
    if default:
        ...
        if resource:  # Launcher
            ...
            blocks += split_text_to_embeds(title + " — BETA", desc)
        else:  # Game
...
def check_for_updates():
    urls = [
        ("https://prod-cn-alicdn-gamestarter.kurogame.com/launcher/launcher/10008_Pa0Q0EMFxukjEqX33pF9Uyvdc8MaGPSz/G152/index.json", "Wuthering Waves Launcher CN"),
        ("https://prod-cn-alicdn-gamestarter.kurogame.com/launcher/game/G152/10008_Pa0Q0EMFxukjEqX33pF9Uyvdc8MaGPSz/index.json", "Wuthering Waves Game CN")
    ]
