...
# ================= Discord =================
def split_text_to_embeds(title, text, color=4278255360, max_len=1024):
...
def send_webhook(data, title, webhook_url, batch_size=1):
    ...
    if predownload:
        ...
        blocks += split_text_to_embeds(title + " — Predownload", desc, color=4293585799)
...
def check_for_updates():
    urls = [
        ...
        ("https://prod-alicdn-gamestarter.kurogame.com/launcher/game/G153/50013_HiDX7UaJOXpKl3pigJwVxhg5z1wllus5/index.json", "Wuthering Waves BETA OS (Game)")
    ]
