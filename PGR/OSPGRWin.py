...
def check_for_updates():
    ...
    url_1 = "https://prod-alicdn-gamestarter.kurogame.com/pcstarter/prod/starter/4/G143/index.json"
    url_2 = "https://prod-alicdn-gamestarter.kurogame.com/pcstarter/prod/game/G143/4/index.json"
    ...
    if response_1.status_code == 200:
        ...
        if data_1 != last_data_1:
            send_webhooks(data_1, url_1, "Punishing Gray Raven OS (LAUNCHER)", last_data_1)
            last_data_1 = data_1
    else:
    ...
    if response_2.status_code == 200:
        ...
        if data_2 != last_data_2:
            send_webhooks(data_2, url_2, "Punishing Gray Raven OS (Game)", last_data_2)
            last_data_2 = data_2
    else:
