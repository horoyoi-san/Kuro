...
BOT_ICON = (
    ...
    "horoyoi-san/Kuro/refs/heads/Webhook/assets/ww.png"
)
...
async def main():
    ...
    urls = [
        (
            "https://prod-volcdn-gamestarter.kurogame.net/launcher/launcher/50013_HiDX7UaJOXpKl3pigJwVxhg5z1wllus5/G153/index.json",
            "Wuthering Waves BETA-Launcher",
        ),
        (
            "https://prod-alicdn-gamestarter.kurogame.com/launcher/game/G153/50013_HiDX7UaJOXpKl3pigJwVxhg5z1wllus5/index.json",
            "Wuthering Waves BETA-Game",
        ),
    ]
