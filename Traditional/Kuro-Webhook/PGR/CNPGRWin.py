...
# กำหนด Webhook URLs
webhook_urls = {
    "Wuthering Waves": 'https://discord.com/api/webhooks/1313874393532989532/0mN1RuiIcN9zDC4HmE4PIOcAPN7B73tgX2TUHMpQH3EkmRTiy5LizlR1PZsnf-J0RSQs',
    "Wuthering Waves 2": 'https://discord.com/api/webhooks/1315273814132785273/KCEkUloeo75HpgwrEVhXDfRzLSuOB7LHf0Nm1zCme0I1s-bl_jkujpcVZC8KSKifEkNU',
...
def check_for_updates():
    ...
    url_1 = "https://prod-cn-alicdn-gamestarter.kurogame.com/pcstarter/prod/starter/10001/G148/index.json"
    url_2 = "https://prod-cn-alicdn-gamestarter.kurogame.com/pcstarter/prod/game/G148/10001/index.json"
    ...
    if response_1.status_code == 200:
        ...
        if data_1 != last_data_1:
            send_webhooks(data_1, url_1, "Punishing Gray Raven CN (LAUNCHER)", last_data_1)
            last_data_1 = data_1
    else:
    ...
    if response_2.status_code == 200:
        ...
        if data_2 != last_data_2:
            send_webhooks(data_2, url_2, "Punishing Gray Raven CN (Game)", last_data_2)
            last_data_2 = data_2
    else:
...
def send_webhook(data, url, title, webhook_key, last_data):
        ...
        "embeds": [
            {
                ...
                "fields": embed_fields,
                "image": {
                    "url": "https://static.wikia.nocookie.net/punishing-gray-raven/images/3/3c/V2-c836b61861815c5f798429ba1f021b87_1200x500.jpg/revision/latest?cb=20191214084458"  # เพิ่มรูปภาพที่ด้านล่าง
                }
            }
        ]
    }
    ...
    webhook_data["embeds"][0]["thumbnail"] = {
        "url": "https://play-lh.googleusercontent.com/EwolwmpxNBLGQgDW4wRJy1TkMjFE5-7sE93I0gpLHSc49oJy4TON8AGHBaHdFIA8nRU"  # เพิ่มลิงก์รูปภาพที่ด้านบนขวา
    }
