...
:buildAllVariants
    SETLOCAL ENABLEDELAYEDEXPANSION
        : call:cargoReleaseBuild "cn_beta_2_8_0,%~1" %~1
        call:cargoReleaseBuild "os_beta_2_8_0,%~1" %~1
        : call:cargoReleaseBuild "os_live_2_7_0,%~1" %~1
        : call:cargoReleaseBuild "cn_live_2_7_0,%~1" %~1
    ENDLOCAL
EXIT /B 0
